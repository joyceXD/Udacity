# -*- coding: utf-8 -*-
"""
Created on Tue Jul 26 21:12:18 2016
...
def process_tag(element):
    ...
    if problemchars.search(k_value) :
        ...
        if k_value_list[0] == 'addr':
            k_value_list[0] = 'address'
        
        tag_dict_key = k_value_list[0]
        tag_dict_value = {}
        tag_dict_value[k_value_list[1]] = element.get('v')        
        return tag_dict_key, tag_dict_value
...
def test():
    ...
    data = process_map('open_street_map_data_example_6.xml', True)
    # pprint.pprint(data)
